...
const Contact = () => {
  ...
  const validatePhone = (phone) => {
    ...
    if (countryCode === '7') {
      ...
      // Италия: +39 (2 цифры кода) + 9-10 цифр номера = 11-12 цифр всего после +
      // Пример: +39 331 153 5788 = 12 цифр (39 + 10 цифр номера)
  ...
  return (
    <section
      id="contact"
      className="section-padding bg-white text-color3"
    >
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
          ...
          <div className="bg-color2/10 rounded-2xl p-4 sm:p-6 md:p-8 border border-color2/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                <label className="block text-color3 mb-2 text-sm sm:text-base">{t('contact.form.name')} *</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
                  ...
                  required
                  className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border border-color2/30 rounded-lg text-color3 text-sm sm:text-base placeholder-color3/50 focus:outline-none focus:border-color1 transition-colors"
                  placeholder={t('contact.form.namePlaceholder')}
                />
              </div>
              <div>
                <label className="block text-color3 mb-2 text-sm sm:text-base">
                ...
                <input
                  ...
                  required
                  className={`w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border rounded-lg text-color3 text-sm sm:text-base placeholder-color3/50 focus:outline-none transition-colors ${
                    emailError && emailTouched
                      ? 'border-red-400 focus:border-red-400'
                      : 'border-color2/30 focus:border-color1'
                  }`}
              ...
              <div>
                <label className="block text-color3 mb-2 text-sm sm:text-base">{t('contact.form.message')}</label>
                <textarea
                  name="message"
                  value={formData.message}
                  onChange={handleChange}
                  rows="4"
                  className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border border-color2/30 rounded-lg text-color3 text-sm sm:text-base placeholder-color3/50 focus:outline-none focus:border-color1 transition-colors resize-none"
              ...
              <button
                ...
                className="w-full px-4 py-3 sm:px-6 sm:py-4 bg-color3 text-color1 rounded-lg font-oswald font-semibold text-base sm:text-lg uppercase tracking-wider hover:bg-color3/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
                    <svg className="animate-spin h-5 w-5" xmlns="http://www.w3.org/20000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <h3 className="text-xl sm:text-2xl font-oswald font-bold mb-4 sm:mb-6 text-color3">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                >
                  ...
                  <span className="text-color3 font-semibold text-sm sm:text-base">WhatsApp</span>
                </a>
                <a
